...
class Embed(commands.Cog):
    ...
    async def _embed(self, ctx):
        ...
        _tick  = _e("ztick")  or "✅"
        _cross = _e("zcross") or "❌"
        button_send = Button(label="Send Embed",  emoji=_tick,  style=discord.ButtonStyle.success)
        button_send.callback = send_callback

        button_delete = Button(label="Cancel Setup",  emoji=_cross, style=discord.ButtonStyle.danger)
