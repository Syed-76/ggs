...
class Nightmode(commands.Cog):
    ...
    async def enable_nightmode(self, ctx):
        if ctx.guild.member_count < 50:  
            return await ctx.send(embed=discord.Embed(title=f"{_e('zcross')} Access Denied",
                color=self.color,
        ...
        if not own and not (
            ...
            return await ctx.send(embed=discord.Embed(title=f"{_e('zwarning')} Access Denied",
                color=self.color,
        ...
        if not manageable_roles:
            return await ctx.send(embed=discord.Embed(title=f"{_e('zcross')} Error",
                color=self.color,
        ...
        await ctx.send(embed=discord.Embed(title=f"{_e('ztick')} Success",
            color=self.color,
