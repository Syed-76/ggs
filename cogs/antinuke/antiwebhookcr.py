...
class AntiWebhookCreate(commands.Cog):
    ...
    async def on_webhooks_update(self, channel):
        ...
        # We check the audit log for a webhook_create action to handle creation specifically.
        guild = channel.guild
        ...
        entry = await self.fetch_audit_logs(guild, discord.AuditLogAction.webhook_create)
        if entry is None:
            return
